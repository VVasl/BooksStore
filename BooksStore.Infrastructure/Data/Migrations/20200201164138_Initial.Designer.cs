...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BooksStore.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BooksStore.Core.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("BooksStore.Core.Entities.Order", b =>
                {
                    b.HasOne("BooksStore.Core.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BooksStore.Core.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
